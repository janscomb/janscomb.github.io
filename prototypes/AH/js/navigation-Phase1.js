...
$(document).ready(function () {
    ...
    $(".patientEngagement").click(function () {
        ...
        $(".patientEngagement span").removeClass("accord");
        $(".patientEngagement span").addClass("decord");
    });
    ...
    $(".containerContent, .scheduling, .codingDocumentation, .claimsRegistry, .careManagement, .other").click(function () {
        ...
        $(".patientEngagement span").addClass("accord");
        $(".patientEngagement span").removeClass("decord");
    });
    ...
    $(".scheduling").click(function () {
        ...
        $(".scheduling span").removeClass("accord");
        $(".scheduling span").addClass("decord");
    });
    ...
    $(".containerContent, .patientEngagement, .codingDocumentation, .claimsRegistry, .careManagement, .other").click(function () {
        ...
        $(".scheduling span").addClass("accord");
        $(".scheduling span").removeClass("decord");
    });
    ...
    $(".codingDocumentation").click(function () {
        ...
        $(".codingDocumentation span").removeClass("accord");
        $(".codingDocumentation span").addClass("decord");
    });
    ...
    $(".containerContent, .patientEngagement, .scheduling, .claimsRegistry, .careManagement, .other").click(function () {
        ...
        $(".codingDocumentation span").addClass("accord");
        $(".codingDocumentation span").removeClass("decord");
    });
    ...
    $(".claimsRegistry").click(function () {
        ...
        $(".claimsRegistry span").removeClass("accord");
        $(".claimsRegistry span").addClass("decord");
    });
    ...
    $(".containerContent, .patientEngagement, .scheduling, .codingDocumentation, .careManagement, .other").click(function () {
        ...
        $(".claimsRegistry span").addClass("accord");
        $(".claimsRegistry span").removeClass("decord");
    });
    ...
    $(".subContainer").click(function () {
        $(".mainMilestones").slideUp( "fast", function() {
            ...
            $(".patientEngagement span, .scheduling span, .codingDocumentation span, .claimsRegistry span").addClass("accord");
            $(".patientEngagement span, .scheduling span, .codingDocumentation span, .claimsRegistry span").removeClass("decord");
        });
    });
